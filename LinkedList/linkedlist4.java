...
public class linkedlist4 {
    ...
    public void add(int idx, int data){
     ...
     public int removeFirst(){
        ...
        }//whem head and teil will be at same indix
        else if(size ==1){
            int val=head.data;
             head=tail=null;
    size=0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Before deletion, the size of the linked list is: " + linkedlist4.size);

        ll.removeFirst();
        ll.print();

        System.out.println("After deletion, the size of the linked list is: " + linkedlist4.size);
    }
}
